    ...
    public function update(Request $request, $id)
{
    ...
    $validator = Validator::make($request->all(), [
        'nameUser' => 'required|max:255',
        'username'=> 'required|unique:fotografo,username,'.$id,
        'phone' => 'required|digits:10',
        'email' => 'required|email|unique:fotografo,email,'.$id,
        'adress' => 'required|max:255',
        'birthday' => 'required|date',
        'description' => 'required|max:255',
        'image' => 'required|',
    ...
    $fotografo->password = Hash::make($request->password);
    ...
    public function updatePartial(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            'nameUser' => 'max:255',
            'username'=> 'unique:fotografo,username,'.$id,
            'phone' => 'digits:10',
            'email' => 'email|unique:fotografo,email,'.$id,
            'adress' => 'max:255',
            'birthday' => 'date',
            'description' => 'max:255',
            'image' => '',
